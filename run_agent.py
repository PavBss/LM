...
from main import cuda_supports_bf16
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Run Clyx coding-agent locally on Windows/Linux.")
    ...
    parser.add_argument("--agent_root", type=str, default=".")
    ...
    parser.add_argument("--no_plan_mode", action="store_true", help="Disable the plan-first phase and run the legacy tool loop directly.")
    ...
    parser.add_argument("--profile", default="coding-agent")
